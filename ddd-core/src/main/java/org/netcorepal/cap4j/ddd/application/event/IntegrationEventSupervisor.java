...
public interface IntegrationEventSupervisor {
     ...
     * @param <EVENT>              集成事件类型
     */
    default <EVENT> void attach(Supplier<EVENT> eventPayloadSupplier){
        attach(eventPayloadSupplier, LocalDateTime.now());
    }
     ...
     * @param <EVENT>              集成事件类型
     */
    default <EVENT> void attach(Supplier<EVENT> eventPayloadSupplier, Duration delay){
        attach(eventPayloadSupplier, LocalDateTime.now().plus(delay));
    }
     ...
     * @param <EVENT>              集成事件类型
     */
    <EVENT> void attach(Supplier<EVENT> eventPayloadSupplier, LocalDateTime schedule);
